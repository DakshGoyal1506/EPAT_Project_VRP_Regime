...
Phase 4+ may consume outputs from this package, but Phase 4+ model, strategy, backtest, broker, and report logic should not be documented as Phase 2/3 ownership.
...
- download raw data
- train HAR models
- train HMM, AR-HMM, MSVOL, or MSGARCH regimes
